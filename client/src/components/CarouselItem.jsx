...
class CarouselItem extends React.Component {
  ...
  render() {
    return (
      ...
      <div className={this.props.reviewModal ? `${styles['flexbox-item-carousel']} ${styles.reviewModalItem}` : styles['flexbox-item-carousel']} style={{backgroundColor: this.props.color}} onClick={() => this.props.handleReviewModal(this.props.review, this.props.color)}>
        ...
        <div className={styles.other}>
          <div className={styles.likes}>
            ...
            <div className={styles.likesCount}>{this.props.review.likes}</div>
          </div>
